...
public:
	...
	//Dictionary --> <dic>
	void insert(Data *);//Insert data to Dictionary
	Data * find(string);//Find word in Dictionary
	bool remove(string);//Remove word out of the Dictionary
	void print();//Print All word in Dictionary

	//File
	void loadFile(char *);//Read all word from file to Dictionay
